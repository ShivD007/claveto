...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _configureSelectNotificationSubject() {
    didReceiveLocalNotificationSubject.stream
        .listen((ReceivedNotification receivedNotification) async {
      print(
          'Recieved ${receivedNotification.payload} ${receivedNotification.body} ${receivedNotification.title}');
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Image(
          image: AssetImage("assets/splash_screen/newlogo.png"),
  ...
  Future<void> _zonedScheduleNotification() async {
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        tz.TZDateTime.from(dateTime,
            tz.local), //.now(tz.local).add(const Duration(seconds: 5)),
        const NotificationDetails(
  ...
  Future<void> _checkPendingNotificationRequests() async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) => AlertDialog(
        content: Text(
            '${pendingNotificationRequests[0].payload} pending notification '
            'requests'),
        actions: <Widget>[
          FlatButton(
            onPressed: () {
